...
const mapToResponse = (pkgName = '', data) => {
  ...
  return {
    ...
    high_priority_issues_count: highPrioIssues ? highPrioIssues.length : 0,
    needs_triage_issues_count: needsTriageIssues ? needsTriageIssues.length : 0,
    // no_label_issues_count: noLabelIssues ? noLabelIssues.length : 0,
